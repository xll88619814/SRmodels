...
void DeployResnet50(std::string dev_type = "cpu") {
  std::cout << "Running C++ resnet50 graph executor..." << std::endl;
  ...
  tvm::runtime::ShapeTuple output_shape = output_gpu.Shape();
  tvm::runtime::DataType output_type = output_gpu.DataType();
